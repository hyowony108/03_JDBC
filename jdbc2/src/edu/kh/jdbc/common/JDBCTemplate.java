...
public class JDBCTemplate {
	...
	public static Connection getConnertion() {
		...
		try {
			...
			// 2. Properties가 제공하는 메서드를 이용해서 dirver.xml 파일 내용을 읽어오기
	...
	/** 전달받은 커넥션에 수행한 SQL을 Commit 하는 메서드
	 * @param conn
	 */
	...
	/** 전달받은 Statment or PreparedStatement 둘 다 close() 하는 메서드
	 * + 다형성의 업캐스팅 적용
	 * -> PreparedStatment 는 Statement 의 자식
	 * @param stmt
	 */
